...
describe('CommandManager', () => {
    ...
    beforeEach(() => {
        ...
        commandManager = new CommandManager(botServiceMock, questionStorageMock, clientId, restMock);
    });
    ...
    describe('handleInteraction', () => {
        ...
        it('should handle unknown command for ApplicationCommand', async () => {
            ...
            expect(response).toEqual(createEphemeralResponse('could not find command: unknownCommand'));
        });
        ...
        it('should handle unknown command for ModalSubmit', async () => {
            ...
            expect(response).toEqual(createEphemeralResponse('could not find modal: unknownModal'));
        });
    });
