...
var deleteQuestionFromBankCommand_js_1 = require("../../src/handlers/actions/deleteQuestionFromBankCommand.js");
var vitest_1 = require("vitest");
var v10_1 = require("discord-api-types/v10");
var interactionHelpers_js_1 = require("../../src/util/interactionHelpers.js");
(0, vitest_1.describe)("DeleteQuestionFromBankCommand", function () {
    var questionStorageMock;
    var deleteQuestionFromBankCommand;
    (0, vitest_1.beforeEach)(function () {
        questionStorageMock = {
            deleteQuestion: vitest_1.vi.fn(),
        };
        deleteQuestionFromBankCommand = new deleteQuestionFromBankCommand_js_1.DeleteQuestionFromBankCommand(questionStorageMock);
    });
    (0, vitest_1.describe)("data", function () {
        (0, vitest_1.it)("should return the correct command data", function () {
            var commandData = deleteQuestionFromBankCommand.data();
            (0, vitest_1.expect)(commandData.name).toBe("delete_question_from_bank");
        });
    });
    (0, vitest_1.describe)("execute", function () {
        (0, vitest_1.it)("should delete a question and return a confirmation message", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        (_a = interaction.data.options) === null || _a === void 0 ? void 0 : _a.push({
                            name: "questionid",
                            value: "sampleQuestion",
                            type: v10_1.ApplicationCommandOptionType.String,
                        });
                        return [4 /*yield*/, deleteQuestionFromBankCommand.execute(interaction)];
                    case 1:
                        response = _b.sent();
                        (0, vitest_1.expect)(questionStorageMock.deleteQuestion).toHaveBeenCalledWith("guild-id", "sampleBank", "sampleQuestion");
                        (0, vitest_1.expect)(response).toEqual((0, interactionHelpers_js_1.createEphemeralResponse)("Deleted question: sampleQuestion from sampleBank"));
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        (0, vitest_1.it)("should return an error if the question id is missing", function () { return __awaiter(void 0, void 0, void 0, function () {
            var interaction, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        (0, vitest_1.expect)(response).toEqual((0, interactionHelpers_js_1.generateOptionMissingErrorResponse)("questionid"));
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        questionStorageMock.deleteQuestion = vitest_1.vi
                            .fn()
