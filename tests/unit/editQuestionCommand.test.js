...
(0, vitest_1.describe)("EditQuestionCommand", function () {
    ...
    (0, vitest_1.describe)("handleModalSubmit", function () {
        (0, vitest_1.it)("should update the question correctly when imageUrl and explanationImageUrl are undefined", function () { return __awaiter(void 0, void 0, void 0, function () {
            var interactionDataWithoutUrls, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        interactionDataWithoutUrls = __assign(__assign({}, interactionData), { data: __assign(__assign({}, interactionData.data), { components: createComponents([
                                    { custom_id: "bankname", value: "test-bank" },
                                    { custom_id: "questionText", value: "What is 3 + 3?" },
                                    { custom_id: "timeoutTimeSeconds", value: "30" },
                        ...
                        mockQuestionStorage.getQuestions = vitest_1.vi.fn().mockResolvedValue([question]);
                        return [4 /*yield*/, command.handleModalSubmit(interactionDataWithoutUrls)];
                    case 1:
                        response = (_a.sent());
                        (0, vitest_1.expect)(response.type).toBe(v10_1.InteractionResponseType.ChannelMessageWithSource);
                        ...
                        (0, vitest_1.expect)(mockQuestionStorage.updateQuestion).toHaveBeenCalledWith("guild-id", __assign(__assign({}, question), { question: "What is 3 + 3?", answers: [
                            ...
                            ], correctAnswerId: "answer2", questionShowTimeMs: 30000, imagePartitionKey: question.imagePartitionKey, explanation: "A simple math question", explanationImagePartitionKey: question.explanationImagePartitionKey }));
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = (_a.sent());
                        (0, vitest_1.expect)(response.type).toBe(v10_1.InteractionResponseType.ChannelMessageWithSource);
                        (0, vitest_1.expect)(response.data.content).toBe("Failed to update question");
                        (0, vitest_1.expect)(response.data.flags).toBe(v10_1.MessageFlags.Ephemeral);
                        return [2 /*return*/];
                }
            });
