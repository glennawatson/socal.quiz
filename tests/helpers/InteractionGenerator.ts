...
class InteractionGenerator {
    static generateModalSubmit(guildId: string, bankName: string, question: string, answersInput: string[], correctAnswerIndex: number | string | undefined): APIModalSubmitInteraction {
    ...
    static generateAddQuestionOptions(
        ...
        const answers : APIApplicationCommandInteractionDataStringOption[] = inputAnswers.map((answer, index) => ({
            name: `answer${index + 1}`,
