...
internal sealed class DefaultApiAuthorizationOptionsConfiguration(string applicationName) : IPostConfigureOptions<RemoteAuthenticationOptions<ApiAuthorizationProviderOptions>>
{
