...
export class EditQuestionCommand implements IModalHandlerCommand {
    ...
    public async handleModalSubmit(
        ...
        try {
            ...
            if (!correctAnswer) {
                return createEphemeralResponse(`Could not find the correct answer for index${correctAnswerIndex}`);
            }
    ...
    public async execute(
        ...
        try {
            ...
            const answerIndex = question.answers.findIndex(x => x.answer == question.correctAnswerId);
